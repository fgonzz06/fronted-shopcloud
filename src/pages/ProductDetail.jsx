function ProductDetail() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <p className="text-gray-600">Próximamente: Información del producto</p>
      ...
      <div className="bg-gray-100 rounded-lg p-4 max-w-md">
        ...
        <p className="text-gray-400 text-xs mt-2">Próximamente: Informacion de cada producto disponible</p>
      </div>
    </div>
  );
}
