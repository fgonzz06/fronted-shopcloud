...
2. Ve a AWS Console → Amplify → "Host web app"
3. Conecta tu repositorio (rama `main`)
4. Amplify detectará `amplify.yml` automáticamente
5. Configura las variables de entorno en Amplify Console
